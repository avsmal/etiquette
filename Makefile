...
myprog: main.o MailBox.o Message.o NotifyMessage.o MailBoxSetting.o
	g++ -std=c++11 main.o MailBox.o Message.o NotifyMessage.o MailBoxSetting.o $(vmime) $(notify)-o myprog
